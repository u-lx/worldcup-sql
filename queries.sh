...
echo $($PSQL "SELECT DISTINCT(name) FROM teams INNER JOIN games g ON teams.team_id = g.winner_id OR teams.team_id = g.opponent_id WHERE round='Eighth-Final' AND year=2014")
